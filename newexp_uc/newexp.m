...
%%%
 ...
 function newexp(batch_name,exp_name,Ua,Va,Atide,Hi0,Ai0,Ws,Hbed,Htr,Zn,Zsb,dZs,is_ContinuedRun,is_hires,useSEAICE)
...
%   Nr = 30; %%% no. of z-gridpoints
 ...
 %  Nr = 68; %%% no. of z-gridpoints 
  %%% ~ 2km grid spacing, 3 nodes
  sNx = 4; %%% no. of x-gridpoints per tile
  sNy = 65; %%% no. of y-gridpoints per tile
  nPx = 72; %%% no. of processors in x-direction
  nPy = 3; %%% no. of processors in y-direction
  Nr = 68; %%% no. of z-gridpoints 
  else
...
% %   sNx = 20; %%% no. of x-gridpoints per tile
% %   sNy = 20; %%% no. of y-gridpoints per tile
% %   nPx = 3; %%% no. of processors in x-direction
% %   nPy = 2; %%% no. of processors in y-direction
% %   Nr = 68; %%% no. of z-gridpoints 
% %   %%%% ~ 15km grid spacing
% %   sNx = 20; %%% no. of x-gridpoints per tile
% %   sNy = 27; %%% no. of y-gridpoints per tile
...
%    acct = 'ddp258';
  ...
  use2iceshelves2troughs = false;
  if(use2iceshelves2troughs)
