...
load([prodir '/' expname,'_tidalMOCz_1825days.mat']);
...
vE(vE==0)=NaN;
psiE = zeros(Ny,Nr+1);
psiE(:,2:Nr+1) = cumsum(vE,2)/1e6; %%% Ekman overturning
...
% title('\psi_{res}','FontSize',fontsize+5);
% xlim([20 430]) 
% axis ij
% set(gca,'YTick',[0:1:4]);
...
annotation('textbox',[0.015 0.62 0.05 0.05],'String','a','FontSize',fontsize+2,'LineStyle','None','fontweight', 'bold');
...
plot(yy/1000,-bathy(1,:)/1000,'k--','LineWidth',2);
plot(yy/1000,-bathy(51,:)/1000,'k','LineWidth',2);
[C,h]=contour(YYF/1000,-ZZF/1000,psiE,[-1:0.2:1],'EdgeColor','w','LineWidth',0.7);
...
set(gca,'YDir','reverse');
set(gca,'fontsize',fontsize);
title('\psi_{Ekman}','FontSize',fontsize+5);
xlim([20 430]) 
set(gca,'YTick',[0:1:4]);
    set(gca,'XTick',[0:100:400]);
%%
ax4 = subplot('position',[0.52 0.06+0.32 subplotsize]);
annotation('textbox',[0.485 0.62 0.05 0.05],'String','b','FontSize',fontsize+2,'LineStyle','None','fontweight', 'bold');
...
plot(yy/1000,-bathy(1,:)/1000,'k--','LineWidth',2);
plot(yy/1000,-bathy(51,:)/1000,'k','LineWidth',2);
[C,h]=contour(YYF/1000,-ZZF/1000,psi_standingeddy_z,[-1:0.2:1],'EdgeColor','w','LineWidth',0.7);
...
set(gca,'YDir','reverse');
set(gca,'fontsize',fontsize);
title('\psi_{standing}','FontSize',fontsize+5);
xlim([20 430]) 
...
annotation('textbox',[0.015 0.295 0.05 0.05],'String','c','FontSize',fontsize+2,'LineStyle','None','fontweight', 'bold');
...
annotation('textbox',[0.485 0.295 0.05 0.05],'String','d','FontSize',fontsize+2,'LineStyle','None','fontweight', 'bold');
...
handle=colorbar;set(handle,'position',[0.95 0.05 0.01 0.59])
annotation('textbox',[0.938 0.63 0.05 0.05],'String','(Sv)','FontSize',fontsize+2,'LineStyle','None');


%%

print('-djpeg','-r300',[figdir 'OT_fresh_calgfd.jpeg']);
