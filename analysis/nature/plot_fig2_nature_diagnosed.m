...
load([prodir,'TSgamma_diagnosed.mat'])
...
plot(33:0.02:35,zeros(1,101),':','Color','k','LineWidth',1)
...
plot(S([5 6 8]),-F_band([5 6 8]),'-','Color',yellow,'LineWidth',3) %%% 2km
