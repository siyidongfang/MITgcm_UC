...
set(gca,'YTick',[0:1:4]);
set(gca,'XTick',[0:100:400]);
text(25,3.7,'Ref.','FontSize',fontsize+1,'Color',[0 0 0]);
...
annotation('textbox',[0.88 0.75 0.05 0.05],'String','(m/s)','FontSize',fontsize+2,'LineStyle','None');



%% Write to file
% print('-djpeg','-r300',[figdir 'zonal_circulation_ver2.jpeg']);
