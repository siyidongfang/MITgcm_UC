...
%%%
function  calcOverturning (expdir,expname,prodir)
...
%   vflux_tavg = readIters(exppath,'LaVH2TH',dumpIters,deltaT,tmin,tmax,Nx,Ny,Npt);    
%   h_pt_tavg = readIters(exppath,'LaHs2TH',dumpIters,deltaT,tmin,tmax,Nx,Ny,Npt);    
...
%   save(fullfile(prodir,[expname,'_MOC_theta.mat']), ...
