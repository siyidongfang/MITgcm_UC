...
set(gcf,'Position',[0.25*scrsz(3) 0.15*scrsz(4) 1200*1.5 680*1.4]);
set(gcf,'Color','w');
...
load('/data/MITgcm_ASF-csi/products-hires/hires_Ua-6Va6_Atide0.05_Hi1Ai1_Ws25_analysis_tavg_5yrs.mat', ...
    'UVEL','SALT','THETA','PHIHYD','SIuice','SIarea','SIheff');
load(['/data/MITgcm_ASF-csi/products-hires/hires_Ua-6Va6_Atide0.05_Hi1Ai1_Ws25_analysis_gamma_n.mat'])
...
ax1 = subplot('position',[0.05 0.83 0.25 0.13]);
...
title('$\overline{h_\mathrm{i}}$', 'FontSize', fontsize,'interpreter','latex');
% xlabel('y (km)', 'FontSize', fontsize-2,'interpreter','latex');
ylabel('(m)', 'FontSize', fontsize-1,'interpreter','latex');
xlim([0 400])

ax2 = subplot('position',[0.37 0.83 0.25 0.13]);
...
set(gca,'FontSize',fontsize-3)
title('$\overline{A_\mathrm{i}}$', 'FontSize', fontsize,'interpreter','latex');
% xlabel('y (km)', 'FontSize', fontsize-2,'interpreter','latex');
xlim([0 400])

ax3 = subplot('position',[0.69 0.83 0.25 0.13]);
...
set(gca,'FontSize',fontsize-3)
leg3 = legend('$\overline{u_\mathrm{i}}$','$\overline{u^s_\mathrm{o}}$','FontSize', fontsize,'interpreter','latex');
legend boxoff; set(leg3,'position',[0.7803 0.9617 0.0748 0.03],'Orientation','horizontal')
hold off;
% title('$\overline{u_\mathrm{i}}$, $\overline{u^s_\mathrm{o}}$', 'FontSize', fontsize,'interpreter','latex');
% xlabel('y (km)', 'FontSize', fontsize-2,'interpreter','latex');
...
%%
ax4 = subplot('position',[0.05 0.455 0.25 0.3]);
...
title('$\overline{T}$ ($^\circ$ C)','FontSize', fontsize,'interpreter','latex');
% xlabel('y (km)', 'FontSize', fontsize-2,'interpreter','latex');
ylabel('Depth (km)', 'FontSize', fontsize-1,'interpreter','latex');
set(gca,'color',boxcolor);
%%

ax5 = subplot('position',[0.37 0.455 0.25 0.3]);
...
set(gca,'FontSize',fontsize-3)
set(c5,'Position',[0.63 0.455 0.01 0.3])
title('$\overline{S}$ (psu)','FontSize', fontsize,'interpreter','latex');
% xlabel('y (km)', 'FontSize', fontsize-2,'interpreter','latex');
set(gca,'color',boxcolor);

ax6 = subplot('position',[0.69 0.455 0.25 0.3]);
...
title('$\overline{u_\mathrm{o}}$ (m/s)','FontSize', fontsize,'interpreter','latex');
% xlabel('y (km)', 'FontSize', fontsize-2,'interpreter','latex');
set(gca,'color',boxcolor);
...
ax7 = subplot('position',[0.05 0.075 0.25 0.3]);
...
title('T$^{\mathrm{obs}}$ ($^\circ$ C)','FontSize', fontsize,'interpreter','latex');
xlabel('y (km)', 'FontSize', fontsize+1,'interpreter','latex');
ylabel('Depth (km)', 'FontSize', fontsize-1,'interpreter','latex');
set(gca,'color',boxcolor);

ax8 = subplot('position',[0.37 0.075 0.25 0.3]);
...
xlabel('y (km)', 'FontSize', fontsize-1,'interpreter','latex');
title('S$^{\mathrm{obs}}$ (psu)','FontSize', fontsize,'interpreter','latex');
set(gca,'color',boxcolor);


ax9 = subplot('position',[0.69 0.075 0.25 0.3]);
...
xlabel('y (km)', 'FontSize', fontsize-1,'interpreter','latex');
title('u$^{\mathrm{obs}}_\mathrm{o}$ (m/s)','FontSize', fontsize,'interpreter','latex');
set(gca,'color',boxcolor);

%%
% print('-dpng','-r150','jpo_validation.png');
% saveas(gcf,'jpo_validation','png');