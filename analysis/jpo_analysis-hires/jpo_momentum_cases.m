...
load('../../../MITgcm_ASF-csi/products-hires/sig12.mat')
...
hold off;
set(gca,'fontsize',fontsize);
xlim([20,430]);xticks([100 200 300 400])
ylabel('(10$^4$ N/m)', 'FontSize', fontsize,'interpreter','latex');
...
hold off;
set(gca,'fontsize',fontsize);xticks([100 200 300 400])
ylabel('(10$^4$ N/m)', 'FontSize', fontsize,'interpreter','latex');
xlim([20,420])
...
%%
expname = 'hires_Ua-6Va6_Atide0.05_Hi1Ai1_Ws125';
expdir = '/Volumes/si/MITgcm_ASF-csi/experiments_configuration';
loadexp;
...
text(25,6.2,'$W_s= 250$ km','FontSize',fontsize+1,'Color',[0 0 0],'interpreter','latex');
axis ij
hold off;
set(gca,'fontsize',fontsize);
xlim([20,430])
