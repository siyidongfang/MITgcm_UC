...
annotation('textbox',[0.05 panelbottom 0.05 0.05],'String','(a)','interpreter','latex','FontSize',fontsize,'LineStyle','None');
    p1 = plot(normalized_transient_slope_batch(16,:),-zz,'color','k','LineWidth',lw);
    hold on;
    p2 = plot(normalized_transient_slope_batch(14,:),-zz,'color',blue,'LineWidth',lw);
    p3 = plot(normalized_transient_slope_batch(15,:),-zz,'color',green,'LineWidth',lw);
    p4 = plot(normalized_transient_slope_batch(17,:),-zz,'color',yellow,'LineWidth',lw);
    p5 = plot(normalized_transient_slope_batch(18,:),-zz,'color',orange,'LineWidth',lw);
    p6 = plot(normalized_transient_slope_batch(19,:),-zz,'color',brown,'LineWidth',lw);
...
annotation('textbox',[0.375 panelbottom 0.05 0.05],'String','(b)','interpreter','latex','FontSize',fontsize,'LineStyle','None');
    ...
    p1 = plot(normalized_standing_slope_batch(16,:),-zz,'color','k','LineWidth',lw);
    hold on;
    p2 = plot(normalized_standing_slope_batch(14,:),-zz,'color',blue,'LineWidth',lw);
    p3 = plot(normalized_standing_slope_batch(15,:),-zz,'color',green,'LineWidth',lw);
    p4 = plot(normalized_standing_slope_batch(17,:),-zz,'color',yellow,'LineWidth',lw);
    p5 = plot(normalized_standing_slope_batch(18,:),-zz,'color',orange,'LineWidth',lw);
    p6 = plot(normalized_standing_slope_batch(19,:),-zz,'color',brown,'LineWidth',lw);
    hold off;
    ylim([100 845]); 
    xlim([-0.08 0.08])
    axis ij;
...
annotation('textbox',[0.7 panelbottom 0.05 0.05],'String','(c)','interpreter','latex','FontSize',fontsize,'LineStyle','None');
    p1 = plot(uo_slope_batch(16,:),-zz,'color','k','LineWidth',lw);
    hold on;
    p2 = plot(uo_slope_batch(14,:),-zz,'color',blue,'LineWidth',lw);
    p3 = plot(uo_slope_batch(15,:),-zz,'color',green,'LineWidth',lw);
    p4 = plot(uo_slope_batch(17,:),-zz,'color',yellow,'LineWidth',lw);
    p5 = plot(uo_slope_batch(18,:),-zz,'color',orange,'LineWidth',lw);
    p6 = plot(uo_slope_batch(19,:),-zz,'color',brown,'LineWidth',lw);
    s1 = plot(ui_slope_batch(16).*ones(1,70),-zz,'--','color','k','LineWidth',lw);
    s2 = plot(ui_slope_batch(14).*ones(1,70),-zz,'--','color',blue,'LineWidth',lw);
    s3 = plot(ui_slope_batch(15).*ones(1,70),-zz,'--','color',green,'LineWidth',lw);
    s4 = plot(ui_slope_batch(17).*ones(1,70),-zz,'--','color',yellow,'LineWidth',lw);
    s5 = plot(ui_slope_batch(18).*ones(1,70),-zz,'--','color',orange,'LineWidth',lw);
    s6 = plot(ui_slope_batch(19).*ones(1,70),-zz,'--','color',brown,'LineWidth',lw);
    z_ui = zeros(30,1);
    s1 = scatter(ui_slope_batch(16),z_ui(16),sz,'k','o','filled'); 
    s1 = scatter(ui_slope_batch(14),z_ui(14),sz,blue,'o','filled'); 
    s1 = scatter(ui_slope_batch(15),z_ui(15),sz,green,'o','filled'); 
    s1 = scatter(ui_slope_batch(17),z_ui(17),sz,yellow,'o','filled'); 
    s1 = scatter(ui_slope_batch(18),z_ui(18),sz,orange,'o','filled'); 
    s1 = scatter(ui_slope_batch(19),z_ui(19),sz,brown,'o','filled'); 
    hold off;
    ylim([0 890]); 
    xlim([-0.55 -0.15])
    axis ij;
...
leg1 = legend([p2 p3 p1 p4 p5 p6],...
    '$h_\mathrm{i0}$=0.2 m',...
    '$h_\mathrm{i0}$=0.6 m',...
    '$h_\mathrm{i0}$=1.0 m (Ref.)',...
    '$h_\mathrm{i0}$=1.4 m',...
    '$h_\mathrm{i0}$=1.8 m',...
    '$h_\mathrm{i0}$=2.2 m','FontSize', fontsize-1,'interpreter','latex');
set(leg1,'position',[0.1684 0.5660 0.1771 0.2115])
legend boxoff                
        

print('-dpng','-r150','Feddy_ifs_hi0_normalized.png');
