...
expname1 = 'hires_Ua-6Va6_Atide0.05_Hi1Ai1_Ws25_analysis';
expname2 = 'hires_Ua-6Va6_Atide0.05_Hi1Ai1_Ws25_analysis_new80s';
...
for m=58:62 
  ...
  var_name = diag_fields{m};
  var_data = cell2mat(struct2cell(load(tavg2,var_name)));
