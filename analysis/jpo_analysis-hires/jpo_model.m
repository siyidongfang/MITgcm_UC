...
%     annotation('textbox',[0.53   0.35  0.15 0.01],'String',{'Potential';'temperature';'($^\circ$C)'},'FontSize',fontsize,'LineStyle','None','interpreter','latex');
    ...
    hold off;
    text3 = text(ax52,34.67,3.5,{'Northern';'boundary'},'FontSize',fontsize,'interpreter','latex','color','k');
    text4 = text(ax52,34.2,0.8,{'Southern';'boundary'},'FontSize',fontsize,'interpreter','latex','color','k');
