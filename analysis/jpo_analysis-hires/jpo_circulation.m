...
load([prodir '/' expname '_tavg_5yrs.mat'],'UVEL','SIuice','SIarea','SIheff');
UVEL(UVEL==0) = NaN;
...
[M,c] = contour(yy(1:Ny-50)/1000,-zz/1000,gamma(1:Ny-50,:)',[27.60 28.03 28.27 28.35],'LineColor',GREY);
...
title('$\overline{u_\mathrm{o}}$ (m/s)','FontSize', fontsize+2,'interpreter','latex');
colormap(mycolormap);
caxis(CLIM);
xlim(XLIM);
set(gca,'YTick',[0:1:4]);
...
leg3 = legend('$\overline{u^s_\mathrm{o}}$','$\overline{u_\mathrm{i}}$ (m/s)','FontSize', fontsize+2,'interpreter','latex','orientation','horizontal');
legend boxoff; set(leg3,'position',[0.1 0.93 0.05 0.05])
    
set(gcf, 'InvertHardcopy', 'off')
print('-dpng','-r200','jpo_circ_strength.png');
...
set(gca,'YTick',[0:1:4]);
set(gca,'TickLength',[0.02 0.035])
text(ax1,95,3.4,{'$\mathrm{\Delta \sigma_4}=$','  $-1.076$','  $\mathrm{kg\ m}^{-3}$'},'FontSize', fontsize-1,'interpreter','latex')
...
set(gca,'YTick',[0:1:4]);
set(gca,'TickLength',[0.02 0.035])
text(ax2,95,3.4,{'$\mathrm{\Delta \sigma_4}=$','  $-0.620$','  $\mathrm{kg\ m}^{-3}$'},'FontSize', fontsize-1,'interpreter','latex')
...
set(gca,'YTick',[0:1:4]);
set(gca,'TickLength',[0.02 0.035])
text(ax3,95,3.4,{'$\mathrm{\Delta \sigma_4}=$','  $-0.207$','  $\mathrm{kg\ m}^{-3}$'},'FontSize', fontsize-1,'interpreter','latex')
text(ax3,95,2.6,{'\textbf{Ref.}'},'FontSize', fontsize-1,'interpreter','latex','color',orange)
...
set(gca,'YTick',[0:1:4]);
set(gca,'TickLength',[0.02 0.035])
% text(ax4,94,3.5,{'$\mathrm{\Delta \sigma_4}=$','$0\ \mathrm{kg\ m}^{-3}$'},'FontSize', fontsize-1,'interpreter','latex')
text(ax4,95,3.4,{'$\mathrm{\Delta \sigma_4}=$','  $0.000$','  $\mathrm{kg\ m}^{-3}$'},'FontSize', fontsize-1,'interpreter','latex')
...
set(gca,'YTick',[0:1:4]);
set(gca,'TickLength',[0.02 0.035])
text(ax5,95,3.4,{'$\mathrm{\Delta \sigma_4}=$','  $0.204$','  $\mathrm{kg\ m}^{-3}$'},'FontSize', fontsize-1,'interpreter','latex')
...
set(gca,'YTick',[0:1:4]);
set(gca,'TickLength',[0.02 0.035])
text(ax6,95,3.4,{'$\mathrm{\Delta \sigma_4}=$','  $0.409$','  $\mathrm{kg\ m}^{-3}$'},'FontSize', fontsize-1,'interpreter','latex')
...
print('-dpng','-r200','jpo_circ_structure.png');
