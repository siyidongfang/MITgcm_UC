...
% %%%%%%
load(['hires_Ua-6Va6_Atide0.05_Hi1Ai1_Ws25_analysis_tidalEddyMeanAdvec_exact_1825days.mat'],...
    'totalAdvec_csi_xzint','totalAdvec_MITgcm_xzint',...
    'meanAdvec_xzint','eddyAdvec_xzint','tidalAdvec_MITgcm_xzint','tidalAdvec_csi_xzint')
%%%%%%

ax1 = subplot('position',[0.09 0.7 subplotsize]);
annotation('textbox',[0.93 0.685 0.05 0.05],'String','(a)','interpreter','latex','FontSize',fontsize+2,'LineStyle','None');
ltot = plot(yy/1000,totalAdvec_MITgcm_xzint/1e4,'Color',green,'LineWidth',1.5);
hold on
...
ltidal = plot(yy/1000,tidalAdvec_MITgcm_xzint/1e4,'-.','Color',yellow,'LineWidth',1);
...
set(leg3,'position',[0.5762    0.8244    0.3    0.1040])
xlim([20,430])
...
%%%%%%
load(['hires_Ua-6Va6_Atide0.05_Hi1Ai1_Ws25_sdiff3_prod_tidalEddyMeanAdvec_exact_1825days.mat'],...
    'totalAdvec_csi_xzint','totalAdvec_MITgcm_xzint',...
    'meanAdvec_xzint','eddyAdvec_xzint','tidalAdvec_MITgcm_xzint','tidalAdvec_csi_xzint')
%%%%%%

ax2 = subplot('position',[0.09 0.38 subplotsize]);
...
text(25,ydown-2,'$\Delta \sigma_4 =0.409\ \mathrm{kg\ m^{-3}}$','FontSize',fontsize+1,'Color',[0 0 0],'interpreter','latex');
hold off;
axis ij
set(gca,'fontsize',fontsize);
ylabel('(10$^4$ N/m)', 'FontSize', fontsize,'interpreter','latex');
...
%%%%%%
load(['hires_Ua-6Va6_Atide0.05_Hi1Ai1_Ws25_ssurf33_analysis_tidalEddyMeanAdvec_exact_1825days.mat'],...
        'totalAdvec_csi_xzint','totalAdvec_MITgcm_xzint',...
    'meanAdvec_xzint','eddyAdvec_xzint','tidalAdvec_MITgcm_xzint','tidalAdvec_csi_xzint')
%%%%%%

ax3 = subplot('position',[0.09 0.06 subplotsize]);
...
ltidal = plot(yy/1000,tidalAdvec_MITgcm_xzint/1e4,'-.','Color',yellow,'LineWidth',1);
plot(yy/1000,zeros(1,Ny),':','Color',gray,'LineWidth',1);
% ltot_MITgcm = plot(yy/1000,totalAdvec_csi_xzint/1e4,'Color',pink,'LineWidth',1.5);
...
text(130,yup+0.5,'Slope','FontSize',fontsize,'Color',[0.5 0.5 0.5],'interpreter','latex');
text(260,yup+0.5,'Deep ocean','FontSize',fontsize,'Color',[0.5 0.5 0.5],'interpreter','latex');
text(25,ydown-0.5,'$\Delta \sigma_4 =-1.076\ \mathrm{kg\ m^{-3}}$','FontSize',fontsize+1,'Color',[0 0 0],'interpreter','latex');
...
%% Write to file
print('-dpng','-r200','TidalEddyMeanAdvec_exact.png');
