...
ax1 = subplot('position',[0.06 0.77 subplotsize]);
annotation('textbox',[0.45 0.745 0.05 0.05],'String','(a)','interpreter','latex','FontSize',fontsize+2,'LineStyle','None');
...
leg0 = legend(ah,l1,'Wind stress','FontSize', fontsize,'interpreter','latex');
...
set(leg1,'position',[0.278  0.885  0.190  0.085])
...
leg2=legend([l1 l2 l4 l3],'Wind stress','Ocean-ice stress',...
    ...
    'interpreter','latex', 'FontSize', fontsize); %    'Residual terms'...
set(leg2,'position',[ 0.6765    0.9014    0.2920    0.0686])
xlim([20,420])
...
ax1 = subplot('position',[0.06 0.53 subplotsize]);
annotation('textbox',[0.45 0.505 0.05 0.05],'String','(c)','interpreter','latex','FontSize',fontsize+2,'LineStyle','None');
...
%%
expdir = '~/MITgcm_ASF-experiments';
expname = 'ws5_Ua-6Va6_Atide0.05_Hi0Ai0_Ws125_lores2';
calcMomBudgetFromTendency_xint;
calcMomBudget_ice_xint;

ax1 = subplot('position',[0.06 0.29 subplotsize]);
annotation('textbox',[0.45 0.265 0.05 0.05],'String','(e)','interpreter','latex','FontSize',fontsize+2,'LineStyle','None');
...
%%
expdir = '/data/MITgcm_ASF-csi/experiments/';
expname = 'sdiff3_Ua-6Va6atide0.05Hi1Ai1_2kmNr30NWs25';
calcMomBudgetFromTendency_xint;
calcMomBudget_ice_xint;

ax1 = subplot('position',[0.06 0.05 subplotsize]);
annotation('textbox',[0.45 0.025 0.05 0.05],'String','(g)','interpreter','latex','FontSize',fontsize+2,'LineStyle','None');
...
%% Write to file
% print('-dpng','-r150','jpo_momentum_cases.png');
