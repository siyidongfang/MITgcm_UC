...
%%% sydf end
    ...
    patchcolor = [0.95 0.95 0.95];
    patch(patchPointsX,patchPointsY,figureColor,'EdgeColor',figureColor,'Parent',breakAxes);
% patch(patchPointsX,patchPointsY ,patchcolor,'EdgeColor',patchcolor,'Parent',breakAxes);

    %Create A Line To Delineate the left and right edge of the patch
    edgecolor = [0.85 0.85 0.85];
    line('xData',xPoints1,'ydata',yPoints,'Parent',breakAxes,'Color',edgecolor,'LineWidth',mainLineWidth);
    line('xData',xPoints2,'ydata',yPoints,'Parent',breakAxes,'Color',edgecolor,'LineWidth',mainLineWidth);
