%%% add the results from the 2 layer model
clear all;close all;
...
plot(Atide,Ttot_slope(nAtide),'d:','Color',orange,'MarkerFaceColor',orange,'LineWidth',3)
ylim(YLIM2);
...
plot(abs_ua,Ttot_slope(nabs_ua),'d:','Color',orange,'MarkerFaceColor',orange,'LineWidth',3)
ylim(YLIM2);
...
plot(va,Ttot_slope(nva),'d:','Color',orange,'MarkerFaceColor',orange,'LineWidth',3)
ylim(YLIM2);
ylabel('(Sv/km)','FontSize', fontsize-1,'interpreter','latex');
hold off
...
plot(hi0,Ttot_slope(hi0),'d:','Color',orange,'MarkerFaceColor',orange,'LineWidth',3)
...
plot(ws,Ttot_slope(nws),'d:','Color',orange,'MarkerFaceColor',orange,'LineWidth',3)
...
plot(res,Ttot_slope(nres),'d:','Color',orange,'MarkerFaceColor',orange,'LineWidth',3)
...
plot(buoy,Ttot_slope(nbuoy),'d:','Color',orange,'MarkerFaceColor',orange,'LineWidth',3)
