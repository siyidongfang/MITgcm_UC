...
vu_dv_dx = uv_eddy .* dv_dx;
vu_dv_dyx= 0.25 * (vu_dv_dx(1:Nx,1:Ny,:) + vu_dv_dx([2:Nx 1],1:Ny,:) + vu_dv_dx(1:Nx,[2:Ny 1],:) + vu_dv_dx([2:Nx 1],[2:Ny 1],:));
...
MKE_EKE = -  (usq_du_dx + uv_du_dy + uw_du_dz + vu_dv_dx + vsq_dv_dy + vw_dv_dz);
% MKE_EKE = -  (usq_du_dx + uv_du_dy + vu_dv_dx + vsq_dv_dy); %%% Horizontal component
