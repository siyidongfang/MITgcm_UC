...
tt_slope = tt(xidx,yidx,zidx);
mask_cdw = ones(length(xidx),length(yidx),length(zidx)); %%% mask of the undercurrent
% mask_cdw(tt_slope>0)=1;
...
Um_dPhiX_zint = rho0.*sum(mask_cdw.*Um_dPhiX(xidx,yidx,zidx).*hFacW(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
Vm_dPhiY_zint = rho0.*sum(mask_cdw.*Vm_dPhiY(xidx,yidx,zidx).*hFacS(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');

%%% momentum tendency from advection terms
Um_Advec_zint = rho0.*sum(mask_cdw.*Um_Advec(xidx,yidx,zidx).*hFacW(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
Vm_Advec_zint = rho0.*sum(mask_cdw.*Vm_Advec(xidx,yidx,zidx).*hFacS(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');

%%% momentum tendency from dissipation
Um_Diss_zint = rho0.*sum(mask_cdw.*Um_Diss(xidx,yidx,zidx).*hFacW(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
Vm_Diss_zint = rho0.*sum(mask_cdw.*Vm_Diss(xidx,yidx,zidx).*hFacS(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');

%%% momentum tendency from external forcing (ice-ocean stress)
Um_Ext_zint = rho0.*sum(mask_cdw.*Um_Ext(xidx,yidx,zidx).*hFacW(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
Vm_Ext_zint = rho0.*sum(mask_cdw.*Vm_Ext(xidx,yidx,zidx).*hFacS(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
...
Um_Cori_zint = rho0.*sum(mask_cdw.*Um_Cori(xidx,yidx,zidx).*hFacW(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
Vm_Cori_zint = rho0.*sum(mask_cdw.*Vm_Cori(xidx,yidx,zidx).*hFacS(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
 
%%% momentum tendency from Vorticity Advection
Um_AdvZ3_zint = rho0.*sum(mask_cdw.*Um_AdvZ3(xidx,yidx,zidx).*hFacW(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
Vm_AdvZ3_zint = rho0.*sum(mask_cdw.*Vm_AdvZ3(xidx,yidx,zidx).*hFacS(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');

%%% momentum tendency from Vertical Advection (Explicit part)
Um_AdvRe_zint = rho0.*sum(mask_cdw.*Um_AdvRe(xidx,yidx,zidx).*hFacW(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
Vm_AdvRe_zint = rho0.*sum(mask_cdw.*Vm_AdvRe(xidx,yidx,zidx).*hFacS(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3,'omitnan');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
VV = sum(mask_cdw.*vv(xidx,yidx,zidx).*hFacS(xidx,yidx,zidx).*DZ(xidx,yidx,zidx),3);
