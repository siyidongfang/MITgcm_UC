...
%     annotation('textbox',[0 0.98 0.15 0.01],'String','(a)','FontSize',fontsize+2,'LineStyle','None');
    ...
    annotation('textbox',[0.001 0.999 0.15 0.01],'String','A','FontSize',fontsize+2,'fontweight','bold','LineStyle','None');
...
%     annotation('textbox',[0.33 0.98 0.15 0.01],'String','(b)','FontSize',fontsize+2,'LineStyle','None');
    ...
    annotation('textbox',[0.335 0.999 0.15 0.01],'String','B','FontSize',fontsize+2,'fontweight','bold','LineStyle','None');
...
%     annotation('textbox',[0.665 0.98 0.15 0.01],'String','(c)','FontSize',fontsize+2,'LineStyle','None');
    ...
    annotation('textbox',[0.668 0.999 0.15 0.01],'String','C','FontSize',fontsize+2,'fontweight','bold','LineStyle','None');
...
%%
     ...
     figdir = '/Users/ysi/MITgcm_UC/analysis_uc/plots/fig3/';
