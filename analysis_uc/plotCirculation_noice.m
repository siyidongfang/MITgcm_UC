...
expname= 'noice_ssurf33_0dS_lores_Ua0Va0_Atide0_Hi0Ai0_Ws25_prod';
loadexp;
...
text(25,3.5,{'No sea ice,', 'no winds, no tides'},'FontSize',fontsize+1,'Color',[0 0 0]);
...
expname= 'noice_ssurf33_0dS_lores_Ua-2Va2_Atide0_Hi0Ai0_Ws25_prod';
loadexp;
load([prodir expname '_tavg_5yrs.mat'],'UVEL')
UVEL(UVEL==0) = NaN;
aaa1=squeeze(nanmean(UVEL,1));
...
set(gca,'YTick',[0:1:4]);
set(gca,'XTick',[0:100:400]);
text(25,3.5,{'No sea ice,', 'weak winds, no tides'},'FontSize',fontsize+1,'Color',[0 0 0]);
...
set(gca,'YTick',[0:1:4]);
set(gca,'XTick',[0:100:400]);
text(25,3.5,{'No sea ice,', 'no winds, with tides'},'FontSize',fontsize+1,'Color',[0 0 0]);
...
%% Write to file
print('-djpeg','-r300',[figdir 'zonal_circulation_no_ice.jpeg']);
