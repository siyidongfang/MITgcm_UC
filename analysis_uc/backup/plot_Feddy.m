...
annotation('textbox',[0.05 panelbottom 0.05 0.05],'String','(a)','interpreter','latex','FontSize',fontsize,'LineStyle','None');
    p1 = plot(normalized_transient_slope_batch(20,:),-zz,'color','k','LineWidth',lw);
    hold on;
    p2 = plot(normalized_transient_slope_batch(21,:),-zz,'color',blue,'LineWidth',lw);
    p3 = plot(normalized_transient_slope_batch(22,:),-zz,'color',green,'LineWidth',lw);
    p4 = plot(normalized_transient_slope_batch(23,:),-zz,'color',yellow,'LineWidth',lw);
    p5 = plot(normalized_transient_slope_batch(24,:),-zz,'color',orange,'LineWidth',lw);
    hold off;
    ylim([100 845]); 
    xlim([-0.05 0.6])
    axis ij;
...
annotation('textbox',[0.375 panelbottom 0.05 0.05],'String','(b)','interpreter','latex','FontSize',fontsize,'LineStyle','None');
    ...
    p1 = plot(normalized_standing_slope_batch(20,:),-zz,'color','k','LineWidth',lw);
    hold on;
    p2 = plot(normalized_standing_slope_batch(21,:),-zz,'color',blue,'LineWidth',lw);
    p3 = plot(normalized_standing_slope_batch(22,:),-zz,'color',green,'LineWidth',lw);
    p4 = plot(normalized_standing_slope_batch(23,:),-zz,'color',yellow,'LineWidth',lw);
    p5 = plot(normalized_standing_slope_batch(24,:),-zz,'color',orange,'LineWidth',lw);
    hold off;
    ylim([100 845]); 
    xlim([-0.05 0.6])
    axis ij;
...
set(leg1,'position',[0.49 0.20 0.1522 0.1925])
legend boxoff                
        

print('-dpng','-r150','Feddy_ifs_uw_normalized.png');
